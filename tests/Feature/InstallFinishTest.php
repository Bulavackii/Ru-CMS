...
class InstallFinishTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Замок теперь СВОЙ (см. TestCase::markInstalled и phpunit.xml,
        // INSTALL_LOCK_PATH) и заводится на каждый тест. Раньше здесь стояла
        // проверка боевого storage/install.lock с пропуском теста: файл
        // машинно-локальный, и владелец удаляет его, когда смотрит мастер.
        // Теперь его состояние на прогон не влияет вовсе.
