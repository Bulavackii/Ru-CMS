...
return [
    ...
    'search' => [
        ...
        'subtitle' => 'Searching site materials and pages',
        'placeholder' => 'What are you looking for?',
        'submit' => 'Find',
        'count' => ':count result|:count results',
        'approximate' => 'No exact matches — showing what is close to ":terms".',
        'start' => 'What are you looking for?',
        'start_hint' => 'Type a word into the search box above — we will show materials and pages containing it.',
        'too_short' => 'Query is too short',
        'too_short_hint' => 'At least two characters are needed: a single letter matches half the site.',
        'nothing' => 'Nothing found for ":query"',
        'nothing_hint' => 'Neither the titles nor the text of materials and pages contain it.',
        'try_words' => 'Search by separate words:',
        'tips_cap' => 'What to try',
        'tip_spelling' => 'Check the spelling',
        'tip_one_word' => 'Keep a single word instead of a phrase',
        'tip_general' => 'Use a more general term',
        'pages_section' => 'Site pages',
        'materials_section' => 'Materials',
        'pages_more' => 'first :shown shown',
        'latest' => 'Latest materials',
        'latest_all' => 'All materials',
