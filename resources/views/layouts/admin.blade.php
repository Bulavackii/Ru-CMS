...
<head>
  ...
  <style>
    ...
    @media (max-width: 1024px), (max-height: 500px){
        ...
        /* ⚠️ От 600 пикселей шапка снова становится строкой. Её собственная
           вёрстка переключается на строку только с 768 (`md:`), а между 600 и
           768 — это планшет в портрете и телефон в альбомной — заголовок
           занимал первую строку, ссылка «Назад к списку» вторую, а справа
           оставалось пустое поле в половину ширины. Место есть — значит,
           ссылке место в той же строке. */
