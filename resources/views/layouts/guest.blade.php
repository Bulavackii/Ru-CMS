...
<head>
    ...
    <style>
        ...
        @media (max-width: 1023px), (max-height: 500px) {
            ...
            /* Кнопки на экранах двухфакторной проверки: переключатель
               «телефон недоступен» был 35 в высоту, «Копировать» у ключа
               привязки — 40. Ключ набирают руками, если не скопировать,
               и ошибка в одном знаке даёт коды, которые просто не подходят. */
            .au-swap, .tfa-copy { min-height: 44px }
        }
    </style>
