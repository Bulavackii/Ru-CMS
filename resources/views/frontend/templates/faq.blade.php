    ...
    <div class="fq-list">
        @foreach ($faqList as $faq)
            {{-- Первый вопрос открыт: пустой список из одних заголовков не
                 ...
                 раскрывается. --}}
            <details class="fq-item" @if ($loop->first) open @endif>
                <summary class="fq-q">
...
<style>
    ...
    .fq{ max-width:56rem; margin:2.5rem auto; padding:0 1rem }

    /* Мера строки уже, чем у сеток: ответ читают, а не просматривают, и
       строка в 80 знаков утомляет меньше, чем во всю ширину экрана. */
    ...
    .fq-a{ padding:.2rem 1.15rem 1.05rem 1.15rem;
    ...
    .fq-a__text{ margin:.7rem 0 0; font-size:.95rem; line-height:1.65;
