...
php vendor/bin/phpunit --no-coverage    # базовая линия: должно быть 170/170
```
...
**Текущее состояние: 170/170 проходят, 0 ошибок, 0 падений.**
(166 было до сессии 22.07.2026 + 4 новых на 500-ку в `/admin/localization/*`.)
