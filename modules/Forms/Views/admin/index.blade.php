...
@php
    ...
    // длинные — во всю. Это вёрстка, а не смысл поля. Список — из модели, тот
    // же, по которому раскладывает поля сидер форм по умолчанию.
    $halfWidth = \Modules\Forms\Models\Form::HALF_WIDTH_TYPES;
