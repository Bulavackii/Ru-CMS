...
{{-- asset_v, а не asset: без метки версии браузер держит прежнюю копию
     файла, и любая правка оформления блоков не доезжает до посетителя —
     у него страница остаётся свёрстанной по-старому. Тот же помощник уже
     используется редактором для этого же файла. --}}
