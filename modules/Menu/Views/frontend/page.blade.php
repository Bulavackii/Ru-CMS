...
{{-- Оформление блоков содержимого переехало в макет сайта: его получают
     и страницы, и новости. Здесь оно подключалось в единственном месте, из-за
     чего в новостях блоки не работали вовсе. --}}
<style>
