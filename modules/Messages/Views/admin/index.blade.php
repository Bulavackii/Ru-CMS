...
<style>
    ...
    @media (max-width: 640px){
        /* ⚠️ Строке обязателен перенос. Ряд действий здесь занимает всю
           ширину, а сама строка — flex БЕЗ переноса: ряд не переезжал на
           новую строку, а вставал в ту же и выталкивал соседей за край
           экрана. Замер на 375: 17 пикселей прокрутки у всей страницы. */
