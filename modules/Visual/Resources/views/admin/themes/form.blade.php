...
<style>
  ...
  @media (max-width: 720px){
      ...
      .thm-preview__nav > *{ min-width:0 }

      /* Пример темы — макет сайта в миниатюре, и подписи в нём
         намеренно мелкие (кегль там поднимать нельзя, это масштабная
         модель). Его собственная шапка всё равно шире места, поэтому
         пример подрезается по своей рамке, а не выпускает содержимое. */
      .thm-preview{ overflow:hidden }
  }

  /* ⚠️ Подрезка нужна НА ВСЕХ сенсорных, а не только на узких. Правило
     жило под max-width:720, и на планшете в альбомной (1024×768) пример
     вылезал за край на 45 пикселей — замер поймал, глаз бы не заметил. */
  @media (max-width: 1024px), (max-height: 500px){
      .thm-preview{ overflow:hidden }
      .thm-preview__nav{ margin-left:0; width:100%; flex-wrap:wrap }
  }
</style>
@endpush
