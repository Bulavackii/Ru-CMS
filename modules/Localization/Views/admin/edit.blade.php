...
<div class="">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
        <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-white">🌍 Редактирование страны: {{ $country->flag ?? '🏳️' }} {{ $country->name }}</h1>
            <p class="text-gray-500 dark:text-gray-400 mb-0">Код: <code>{{ $country->code }}</code></p>
        </div>
        <div class="btn-group">
                ...
                <div class="p-5">
                    <form action="{{ route('admin.localization.update', $country->code) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                            ...
                            <div class="">
                                <div class="mb-3">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1 d-block">Статус</label>
