...
(function (window) {
    ...
    function fontItems(editor) {
        ...
        // Список сплошной, без заголовков: разделение на «свои» и
        // «системные» — деталь устройства, а не выбора. Автору важно, как
        // шрифт выглядит, и он это видит — каждая строка набрана собой.
