...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    private function loadLegacyModules(string $modulesPath): void
    {
        ...
        $legacyModules = [
            ...
            // Медиатека нужна не только своему разделу: её маршруты зовёт
            // редактор материалов (выбор и загрузка файлов) и быстрые действия
            // на главной панели. Раньше её маршруты грузились только при
            // включённом модуле, а те же имена дублировались в routes/web.php
